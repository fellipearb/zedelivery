...
function ProductCard(props) {
    ...
    card.productVariants[0].price = card.productVariants[0].price.toLocaleString('pt-br', {minimumFractionDigits: 2});
    ...
    return (
        <ProductCardStyle>
            <div className="product" data-testid="ProductCard">
                ...
                <h2 className="name" data-testid="ProductCardName">{card.displayName || card.title}</h2>
